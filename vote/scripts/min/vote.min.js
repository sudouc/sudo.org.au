...
/* harmony import */ var vue_slider_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-slider-component */ "./node_modules/vue-slider-component/dist/index.js");
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    ...
    dragEnd: function dragEnd(slider) {
      var highestAmount = 0;
      var highestIndex;
    ...
    submit: function submit() {
      ...
      this.submitted = true;
      this.$http.post(_this.apiURL + 'vote', {
        'candidates': this.candidates
      }).then(function (response) {
        if (response.body.length > 0) {
          this.$cookie.set('vote', '1827129361', {
            expires: 1
          });
          this.comeback = true;
        }
...
/***/ 1:
/*!************************************!*\
  !*** multi ./vote/scripts/vote.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\sudouc\sudo.org.au\vote\scripts\vote.js */"./vote/scripts/vote.js");
